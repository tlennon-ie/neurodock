...
- Three `### <Project name>` sections, in the order `neurodock`, ``, `phase-0-rfc` (ranked by most-recent decision date: 2026-05-16, 2026-05-15, 2026-05-12).
...
- For `neurodock`, the blocker bullet quotes the literal `awaiting  confirmation`.
- For ``, the most-recent-decision bullet quotes one of the names returned by `recall_decisions`.
...
- [ ] Project order is `neurodock`, ``, `phase-0-rfc`.
