...
- `weekly_rollup(project="neurodock")` returns one open blocker ("awaiting clinical advisor confirmation for Phase 1 launch") and one candidate next action drawn from `next_actions`.
...
3. **Open threads.** Bulleted list. Maximum 3 items. MUST include the blocker about "awaiting clinical advisor confirmation".
...
- [ ] Output contains the blocker text "awaiting clinical advisor confirmation" (exact phrase from the fixture).
