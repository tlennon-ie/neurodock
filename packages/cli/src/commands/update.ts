...
export interface UpdateClientDiff {
...
export interface UpdateRunResult {
  readonly clients: ReadonlyArray<UpdateClientDiff>;
...
function formatDiffs(diffs: ReadonlyArray<UpdateClientDiff>): string[] {
  const out: string[] = [];
  for (const d of diffs) {
