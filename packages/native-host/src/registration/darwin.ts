...
function targets(home: string): ReadonlyArray<BrowserTarget> {
  ...
  return [
    {
      browser: "chrome",
      dir: join(base, "Google", "Chrome", "NativeMessagingHosts"),
    },
    {
      browser: "chromium",
      dir: join(base, "Chromium", "NativeMessagingHosts"),
    },
    {
      browser: "brave",
      dir: join(base, "BraveSoftware", "Brave-Browser", "NativeMessagingHosts"),
    },
    {
      browser: "edge",
      dir: join(base, "Microsoft Edge", "NativeMessagingHosts"),
    },
    { browser: "vivaldi", dir: join(base, "Vivaldi", "NativeMessagingHosts") },
    {
      browser: "firefox",
      dir: join(base, "Mozilla", "NativeMessagingHosts"),
      firefox: true,
    },
  ];
}

export function registerDarwin(
...
export function unregisterDarwin(
