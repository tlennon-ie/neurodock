...
- Ten hand-authored synthesised seed examples across four translation slices (incoming, tone, outgoing, meetings), including a multi-rater Cohen's kappa demo.
...
Phase 2 outreach. CI thresholds ship permissive; tuning follows real
contributions.

References: `plan.md` §7, §9, `packages/evals/CHANGELOG.md`.
