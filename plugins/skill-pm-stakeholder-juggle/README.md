...
```sh
# Install
neurodock plugin add ./plugins/skill-pm-stakeholder-juggle

# Activate
neurodock plugin enable skill-pm-stakeholder-juggle
...
The plugin should appear with `trust: community` and the three triggers listed above. `plugin validate ./plugins/skill-pm-stakeholder-juggle` will check the manifest before install if you want to dry-run.
