...
|---|---|---|
| `official` | Published by the NeuroDock council | No |
| `verified` | Signed by a verified contributor (council keyring) | No |
...
If a PR appears to do any of the above, `community-triage` flags it for council review.
