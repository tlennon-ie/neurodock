...
This lets curated presets (`profiles/adhd-engineer`, `profiles/audhd-founder`, etc.) ship sensible bundles without forcing users to hand-author every field.
