...
- **Version:** `0.0.1` (developer preview, deterministic baseline + LLM-refinement prompt envelope)
...
- v0.0.1 envelopes wrap the v0.1.0 wire contract. The envelope collapses to the wire contract once Phase 2 LLM-refinement flow is the default path.
