...
> Source: A free-standing `CONTRIBUTING.md` at the repository root is a Phase 0 governance deliverable owned by `governance-author`. Until it lands, this page is the canonical contribution guide; `plan.md` §6 and §7 carry the per-area contribution detail.
...
2. **Lived experience leads.** Skills targeted at a neurotype are reviewed by at least one contributor with that neurotype. Self-identification is sufficient.
