...
[`packages/skills/adhd-daily-planner/`](https://github.com/tlennon-ie/neurodock/tree/main/packages/skills/adhd-daily-planner) is the canonical copy-from skill — `v0.1.0`, `status: stable`, and exercises every piece of the contract. Any shipped skill under [`packages/skills/`](https://github.com/tlennon-ie/neurodock/tree/main/packages/skills) is a valid starting point.
:::
...
The canonical copy-from skill is [`packages/skills/adhd-daily-planner/`](https://github.com/tlennon-ie/neurodock/tree/main/packages/skills/adhd-daily-planner) — it is `v0.1.0`, `status: stable`, and exercises every piece of the contract (frontmatter, triggers, MCP dependencies, profile dependencies, body, tests).
...
- [Contribute an eval example](/contribute/contribute-eval-example/) — eval corpus growth is on the [Q3 2026 roadmap](https://github.com/tlennon-ie/neurodock/blob/main/ROADMAP.md#next--q3-2026).
