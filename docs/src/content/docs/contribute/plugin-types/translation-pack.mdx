...
Translation packs are one of the four contribution lanes for the communication layer described in . They are deliberately the highest-leverage lane for non-coders: a translation pack is YAML and prose, not code.
...
-  for the broader communication-layer architecture.
