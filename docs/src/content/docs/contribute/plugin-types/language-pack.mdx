...
The `locales/messages.json` block is for the substrate's own UI strings as they relate to this language (notice text, consent prompts, error messages from the server). UI strings follow the [ICU MessageFormat](https://unicode-org.github.io/icu/userguide/format_parse/messages/) convention used by the docs site and the browser extension.
...
- [ADR 0005 — Translation tool design](/decisions/0005-translation/) for the broader communication-layer architecture and the four contribution lanes.
