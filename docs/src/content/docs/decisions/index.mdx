...
3. Open a PR. Reviewers: at least one council member plus any agent with overlap (`mcp-architect` for substrate ADRs, `clinical-reviewer` for guardrail ADRs, `governance-author` for governance ADRs).
