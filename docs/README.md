...
|---|---|
| `manifesto.mdx` | `plan.md` §1 (until `MANIFESTO.md` is published at repo root) |
| `ethics.mdx` | `plan.md` §8 (until `ETHICS.md` is published at repo root) |
| `contribute/overview.mdx` | `plan.md` §6/§7 (until `CONTRIBUTING.md` is published at repo root) |
| `contribute/governance.mdx` | `plan.md` §12 (until `GOVERNANCE.md` is published at repo root) |
