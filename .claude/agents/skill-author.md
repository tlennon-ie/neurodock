...
- The SKILL.md convention itself needs evolution (rare; flag to council).
...
- A skill is targeted at a neurotype none of the current reviewers identify with — pause and recruit a lived-experience reviewer before merging.
- A community-submitted skill makes clinical claims ("this skill will help your OCD") — escalate to `clinical-reviewer` and the council.
- A skill duplicates an existing skill's purpose — escalate to the council; we prefer one good skill over two competing ones.
