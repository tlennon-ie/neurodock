...
- A task doesn't fit any specialist's scope — flag to the maintainer; this means we have a gap in the fleet.
- Two specialists give conflicting guidance on the same PR — flag to the maintainer; conflicts are rare and meaningful.
