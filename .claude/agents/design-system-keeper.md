...
- A contributor disagrees with a copy correction — discuss in the PR; if unresolved, route to council. The manifesto is the tiebreaker.
- A design token change is proposed (new colour, new font) — flag to council; design tokens are governance-equivalent decisions.
